package com.mooc.battle.viewanimator;
...
public class AnimationBuilder {
    ...
    public AnimationBuilder rubber() {
        scaleX(4, 1.25f, 0.85f, 1.15f, 0.85f, 1.15f, 1);
        scaleY(4, 1.25f, 0.85f, 1.15f, 0.85f, 1.15f, 1);
        return this;
    }
    ...
    public AnimationBuilder revertShake() {
        translationX(0, -25, 25, 0);
        duration(4000);
        interpolator(new CycleInterpolator(1));
        return this;
    ...
    public AnimationBuilder rotationCircle() {
        rotation(0, -30, -60, -90, -120, -150, -180, -210, -240, -270, -300, -330, -359);
        return this;
    }
    ...
    public AnimationBuilder zoomOutIn() {
        scaleX(4f, 1);
        scaleY(4f, 1);
     ...
     * 从左上角移动到中间
     */
    public AnimationBuilder matchSuccessLeft() {
        translationX(-228, 0);
        translationY(-228, 0);
        return this;
    }
     ...
     * 匹配成功右上角移动到中间
     */
    public AnimationBuilder matchSuccessRight() {
        translationX(228, 0);
        translationY(228, 0);
        return this;
    }
     ...
     * @return
     */
    public AnimationBuilder matchSuccessLine(int fromX, int toX, int fromY, int toY) {
    ...
    public AnimationBuilder slideLeftIn(int trans) {
        translationX(trans, 0);
        alpha(0, 1);
        return this;
    }

    public AnimationBuilder slideRightIn(int trans) {
        translationX(trans, 0);
        alpha(0, 1);
        return this;
    }
