...
class SpecialDefaultAdapter(data: ArrayList<RecommendContentBean.DataBean>?) :
    ...
    private fun setPublication(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setColumn(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setOutLink(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setStudyPlan(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
        val value = ResourceTypeConstans.typeStringMap[item.type]
...
//        }
    ...
    private fun setActivityTask(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
        val value = ResourceTypeConstans.typeStringMap[item.type]
    ...
    private fun setMicroKnowLedge(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setMicroLesson(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setSpecial(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
        ...
        if (TextUtils.isEmpty(item.resource_info.title)
            && TextUtils.isEmpty(item.resource_info.updated_time)
        ) {
        ...
        if (!TextUtils.isEmpty(item.resource_info.updated_time)) {
            ...
            holder.setText(R.id.tvTime, item.resource_info.updated_time)
        } else {
    ...
    private fun setTestVolume(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setQuestionnaire(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setDefault(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setBattle(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setMicroProfessional(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setFollowUpData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setAlbumData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setTrackData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setOwnTrackData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setArticleData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setPeriodicalData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setTaskData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
...
//            6 任务已报名未开始 （新增）
    ...
    private fun setEBookData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
    ...
    private fun setCourseData(holder: BaseViewHolder, item: RecommendContentBean.DataBean) {
     ...
     * 中间点的规则,如果前面点亮,点也点亮
     */
    private fun setCourseTypeInfo(textView: TextView, bean: RecommendContentBean.DataBean) {
