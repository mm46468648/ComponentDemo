 ...
 */
class TaskChildAdapter(list: ArrayList<TaskDetailsBean>?, val success: Boolean) :
    BaseQuickAdapter<TaskDetailsBean, BaseViewHolder>(R.layout.item_task_child_detail, list) {
    override fun convert(holder: BaseViewHolder, item: TaskDetailsBean) {
        ...
        holder.setText(R.id.tvTaskTitle, "子任务: ${item.title}")
