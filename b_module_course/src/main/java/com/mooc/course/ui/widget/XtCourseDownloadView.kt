...
class XtCourseDownloadView @JvmOverloads constructor(
...
//        ivDownloadState = findViewById(R.id.ivDownloadState)
    ...
    fun setCourseData(item: ChaptersBean) {
        chaptersBean = item
        val chapterColor =
            if (TextUtils.isEmpty(item.chapterName)) Color.parseColor("#818181") else Color.parseColor(
                "#222222"
            )
        ...
        circleProgressBar?.visibility = stateVisibal
