...
public class SimpleYearView extends YearView {
    ...
    public SimpleYearView(Context context) {
        ...
        mOutRangePaint.setTextSize(CalendarUtil.dipToPx(context, 9));
        mOutRangePaint.setStrokeWidth(CalendarUtil.dipToPx(context, 1.5f));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            boolean inRange = CalendarUtil.isCalendarInRange(calendar, mDelegate);
