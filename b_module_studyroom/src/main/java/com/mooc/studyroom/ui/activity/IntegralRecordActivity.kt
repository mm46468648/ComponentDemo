 ...
 * @date 2020/12/24
 */
@Route(path = Paths.PAGE_INTEGRADL_EXCHANGE_RECORD)
class IntegralRecordActivity:BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val xtCourseDownloadFragment = IntegralRecordFragment.getInstance(bundle)
    ...
    private fun inintView() {
        ...
        inflater.commonTitle.middle_text = "兑换记录"
