...
import com.mooc.setting.fileselector.utils.FileUtil;
import com.mooc.setting.fileselector.utils.SdCardUtil;
import java.io.File;
...
public class FileSelectActivity extends AppCompatActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.set_activity_file_select);
	...
	private void initData() {
		...
		mAdapter = new FileSelectAdapter(this, mData, R.layout.set_item_fileselect, mFrom, mTo);
