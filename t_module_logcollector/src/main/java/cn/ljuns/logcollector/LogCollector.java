...
public class LogCollector implements CrashHandlerListener {
    ...
    LogChangeObserver logChangeObserver = new LogChangeObserver();

    public LogChangeObserver getLogChangeObserver() {
        return logChangeObserver;
    }
    ...
    public void createCleanCommand() throws IOException {
        ...
        if(logChangeObserver.getArrayList().size()>1000){
            logChangeObserver.clear();
        }
