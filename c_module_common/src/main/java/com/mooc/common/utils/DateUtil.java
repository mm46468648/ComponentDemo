...
/**
 * Created by liyusheng on 2017/6/20.
 */
...
//        int offset = TimeZone.getDefault().getRawOffset();
    ...
    private static long dateDiff(long startTime, long endTime) {
...
//    }
    ...
    public static String getDateStrNow(String format) {
        @SuppressLint("SimpleDateFormat") SimpleDateFormat sDateFormat = new SimpleDateFormat(format);
