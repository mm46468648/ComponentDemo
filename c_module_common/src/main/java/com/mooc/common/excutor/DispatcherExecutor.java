package com.mooc.common.excutor;
...
/**
 * @ProjectName: DispatcherExecutor
 * @Package: com.moocxuetang.c_module_common.manager
 * @ClassName: DispatcherExecutor
 * @Description: 统一的线程池调度器
 * @Author: xym
 * @CreateDate: 2020/9/15 2:56 PM
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/9/15 2:56 PM
 * @UpdateRemark: 更新内容
 * @Version: 1.0
 *
 * //////////////使用实例
