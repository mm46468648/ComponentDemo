...
public class PageListPlayManager {
    ...
    static {
        ...
        //添加请求头referer
        dataSourceFactory.getDefaultRequestProperties().set("Referer","http://*.learning.mil.cn");
    ...
    public static MediaSource createLocalVideoMediaSource(Uri uri){
        ...
        ProgressiveMediaSource.Factory factory1 = new ProgressiveMediaSource.Factory(factory);
